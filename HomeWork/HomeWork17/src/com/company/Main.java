...
//        Chapter1.
        {//템창 튜토리얼
            ...
            player.addPotion(Potion.Red_Potion);
...
//        Chpter2.
        {//전투 튜토리얼
            ...
            player.addPotion(Potion.Red_Potion); player.addPotion(Potion.Weapon_Slush); player.addPotion(Potion.Black_Potion);
            player.usePotion(Potion.Red_Potion); player.usePotion(Potion.Weapon_Slush); player.usePotion(Potion.Black_Potion);

            System.out.println();
            System.out.println("1턴");
            System.out.println("사용 중인 포션: "+ player.usingPotionList);
            consumerList.SYSTEM.accept("총 데미지:"+ player.getDamage());
            player.usingPotionList.clear();
            consumerList.SYSTEM.accept("포션 효과 종료");
            scan.nextLine();
